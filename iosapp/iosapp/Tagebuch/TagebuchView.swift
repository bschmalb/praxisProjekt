                ...
                if (!firstUseLog) {
                    VStack (spacing: 10) {
                        Image("Entwicklung")
                            .resizable()
                            .scaledToFit()
                        Text("Trage täglich deinen Fortschritt ein, um diesen nachher in deiner Entwicklung anzusehen. Dadurch behältst du den Überblick darüber, wie nachhaltig du lebst.")
                            .font(.subheadline)
                        .lineSpacing(4)
